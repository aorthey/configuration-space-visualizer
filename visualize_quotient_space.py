...
plt.savefig("images/"+worldName+"_cspace_1.png", bbox_inches='tight')
...
plt.savefig("images/"+worldName+"_cspace_2.png", bbox_inches='tight')
#############################################################
fig = plt.figure(2)
fig.patch.set_facecolor('white')
ax = fig.gca()
...
plotCSpaceDelaunayGrey(Q1,Q2,shade=greyshade)
plt.savefig("images/"+worldName+"_cspace_3.png", bbox_inches='tight')
#############################################################
plt.show()
